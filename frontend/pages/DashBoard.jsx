...
const DashBoard = () => {
  ...
  async function handlecreate() {
    try {
      const data = await axios.post(
        "https://cosmic-chat-fqrq.onrender.com/api/groups/creategroup",
        {
  ...
  async function handleAuthorization(v) {
    try {
      const data = await axios.post(
        "https://cosmic-chat-fqrq.onrender.com/api/member/checkmember",
        {
          groupname: v.groupid,
  ...
  async function handlejoin(groupid) {
    try {
      const data = await axios.post(
        "https://cosmic-chat-fqrq.onrender.com/api/groups/joingroup",
        {
          groupid,
          userid: userdetail.id,
  ...
  async function handlejoinedgroups() {
    try {
      const data = await axios.post(
        "https://cosmic-chat-fqrq.onrender.com/api/groups/joinedgroups",
        {
          userid: userdetail.id,
        }
      );
